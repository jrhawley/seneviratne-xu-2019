...
case_metadata = data.frame(
    Condition = factor(
        rep(c("1stKD", "Ctrl"), c(2, 3)),
        levels = c("Ctrl", "1stKD")
    ),
    Replicate = factor(c(1, 2, 1, 2, 3))
)
...
ggsave(
    "1stKD-Ctrl.read-count-distribution.png",
    height = 20,
    width = 20,
    units = "cm"
)
...
png("1stKD-Ctrl.dispersion.png", width = 12, height = 12, units = "cm", res = 300)
plotDispEsts(dds_filtered)
dev.off()

# Independent filtering plot (not needed because independentFiltering = FALSE))
# =====================================
# png("1stKD-Ctrl.independent-filtering.png", width = 24, height = 12, units = "cm", res = 300)
# plot(
...
# =====================================
cat("Plotting MAs\n")
png("1stKD-Ctrl.MA.png", width = 12, height = 12, units = "cm", res = 300)
...
png("1stKD-Ctrl.rlog.png", width = 12, height = 12, units = "cm", res = 300)
...
png("1stKD-Ctrl.vst.png", width = 12, height = 12, units = "cm", res = 300)
