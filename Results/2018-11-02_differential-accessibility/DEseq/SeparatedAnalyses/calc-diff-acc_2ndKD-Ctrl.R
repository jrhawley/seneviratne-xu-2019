...
ggsave(
    "2ndKD-Ctrl.read-count-distribution.png",
    height = 20,
    width = 20,
    units = "cm"
)
...
png("2ndKD-Ctrl.dispersion.png", width = 12, height = 12, units = "cm", res = 300)
...
# =====================================
cat("Plotting MAs\n")
png("2ndKD-Ctrl.MA.png", width = 12, height = 12, units = "cm", res = 300)
...
png("2ndKD-Ctrl.rlog.png", width = 12, height = 12, units = "cm", res = 300)
...
png("2ndKD-Ctrl.vst.png", width = 12, height = 12, units = "cm", res = 300)
